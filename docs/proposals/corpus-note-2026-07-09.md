...
| Coverage watermark | 2026-07-09 UTC — known-facilitator classic USDC, watermarked. This index is complete through that day *inside the allow-list*. Not a claim about x402 settlement outside the known-facilitator set. |
