...
**Applies to:** `twzrd-x402-gate@0.9.13`, TWZRD Agent Intelligence, and V7 trust receipts  
**Last verified:** 2026-09-12 (properties; install pin is the published 0.9.13 line)  
...
npx -y twzrd-receipt-verifier@^1.4.0 \
