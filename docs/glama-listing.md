...
Advisory preflight is free ($0). Signed execution clearance is **$0.001** (`twzrd.payment_decision.v1` / `quickCheck`). Optional Path A V7 receipts are $0.05 and are not the primary SKU. Pin: `twzrd-x402-gate@0.9.12`.
