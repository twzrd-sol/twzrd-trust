...
| **Path A / V7 Receipt** | Paid Intelligence | Optional $0.05 USDC detailed reputation intelligence and portable signed Ed25519 V7 receipt (`GET /v1/intel/trust/{pubkey}`). Offline-verifiable via `twzrd-receipt-verifier@^1.4.0` (V5/V6/V7). |
