...
One path. Install `twzrd-x402-gate@0.9.7`. Free preflight does not enforce; AutoGate on the pay path does.

1. **Install the gate** — `npm i twzrd-x402-gate@0.9.7` then `installTwzrdAutoGate`
