...
**Spend-control SDK (npm)** • [`twzrd-x402-gate@0.9.13`](https://www.npmjs.com/package/twzrd-x402-gate) + seat [`x402-solana@3.0.0`](https://www.npmjs.com/package/x402-solana)  
...
```bash
npm install twzrd-x402-gate@0.9.13 x402-solana@3.0.0
```
...
One path. Install `twzrd-x402-gate@0.9.13`. Free preflight does not enforce; AutoGate on the pay path does.

1. **Install the gate** — `npm i twzrd-x402-gate@0.9.13` then `installTwzrdAutoGate`
...
|---|---|---|
| `twzrd-x402-gate` | **@0.9.13** | Spend-control SDK (`twzrd.safeFetch`) + pre-sign gate hooks |
