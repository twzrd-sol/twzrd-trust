 ...
 *   3. If decision=warn and x402Fetch is wired: first paid hop is GET
 *      /quick $0.001 (escalateOnWarn). Optional V7 GET /trust $0.05 only
 *      when autoReceipt / requireReceipt fires and /quick did not.
