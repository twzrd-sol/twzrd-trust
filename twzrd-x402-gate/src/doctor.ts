...
const HOSTS: Host[] = [
  {
    ...
    install: "npm install twzrd-x402-gate@0.9.12",
...
const agent = new SolanaAgentKit(wallet, rpcUrl, {
  ...
  },
  {
    ...
    deps: ["@solana/pay-kit"],
    install: "npm install twzrd-x402-gate@0.9.12 @solana/pay-kit",
...
const client = await createPayKitClient({
  ...
  },
  {
    ...
    install: "npm install twzrd-x402-gate@0.9.12 @x402/core @x402/fetch @x402/svm",
