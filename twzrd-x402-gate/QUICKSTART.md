...
**Pin:** `twzrd-x402-gate@0.9.12` + stock PayAI client `x402-solana@3.0.0` (official
...
- **Base mainnet is scored.** Solana mainnet and Base mainnet (`eip155:8453`) run the scored preflight. Other EVM networks get an explicit `unknown`
  (observed; no scored preflight) unless you set
