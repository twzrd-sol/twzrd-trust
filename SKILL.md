...
metadata:
  ...
  gate_npm: twzrd-x402-gate@0.9.13
...
Do not treat a free ReadinessCard (or an optional Path A V7 receipt alone) as “protected.”
...
```bash
npm install twzrd-x402-gate@0.9.13 @x402/core @x402/fetch @x402/svm @solana/kit @scure/base
npx twzrd-cold-start
...
model AND a portable Ed25519-signed V7 receipt.
